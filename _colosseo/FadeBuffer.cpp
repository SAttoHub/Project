...
//#include "Camera.h"
//
//void FadeBuffer::SetupGraphPrimitive()
//{
//	HRESULT result;
...
//}
//
//void FadeBuffer::SetupGraphPrimitiveFade()
//{
//	HRESULT result;
//#pragma region 画像付き箱プリミティブ
//	for (int i = 0; i < MaxGraphPrimitives; i++) {
...
//	LoadShader(&Graph_vsBlob, L"Resource/shader/PostEffectVS.hlsl", "main", "vs_5_0");
//	LoadShader(&Graph_gsBlob, L"Resource/shader/PostEffectGS.hlsl", "main", "gs_5_0");
//	LoadShader(&Graph_psBlob, L"Resource/shader/FadeShader.hlsl", "main", "ps_5_0");
//
//	D3D12_INPUT_ELEMENT_DESC GraphPrimitiveInputLayout[] = {
//		{
//			"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0,
...
//}
//
//void FadeBuffer::LoadShader(ID3DBlob** blob, LPCWSTR FileName, LPCSTR EntryPointName, LPCSTR ModelName)
//{
//	HRESULT result;
//	シェーダーの読み込みとコンパイル
...
//}
//
//void FadeBuffer::InitializeFadeShader()
//{
//	SetupGraphPrimitive();
//}
//
//void FadeBuffer::Initialize() {
//
//	SetupGraphPrimitive();
//}
//
//void FadeBuffer::Draw(int TexNum1)
//{
//	int Num = 0;
...
//}
//
//void FadeBuffer::DrawFade(int TexNum1, int TexNum2)
//{
//	int Num = 0;
//	assert(Num <= MaxGraphPrimitives);
//
