...
void Depth2::SetupGraphPrimitive()
{
	HRESULT result;
...
void Depth2::LoadShader(ID3DBlob **blob, LPCWSTR FileName, LPCSTR EntryPointName, LPCSTR ModelName)
{
	HRESULT result;
	//シェーダーの読み込みとコンパイル
...
void Depth2::ClearDepth()
{
}

void Depth2::PreDrawScene(int Num)
{
	//リソースバリアを変更
