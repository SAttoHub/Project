...
void GameScenes::Initialize()
{
	...
	model = DirectX3dObject::CreateObject(GetModelData(modelData), XMFLOAT3(2000, 0, 0), FBXSHADER);
	...
	skydome->scale = XMFLOAT3(300.0f, 300.0f, 300.0f);
...
void GameScenes::Update()
{
	...
	model->position = XMFLOAT3(100, 100, 0);
