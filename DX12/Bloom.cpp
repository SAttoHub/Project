...
void Bloom::SetupGraphPrimitive()
{
	HRESULT result;
...
#pragma endregion
	...
	LoadShader(&Graph_gsBlob, L"Resource/shader/BloomGS.hlsl", "main", "gs_5_0");
	LoadShader(&Graph_psBlob, L"Resource/shader/BloomPS.hlsl", "main", "ps_5_0");
...
void Bloom::LoadShader(ID3DBlob **blob, LPCWSTR FileName, LPCSTR EntryPointName, LPCSTR ModelName)
{
	HRESULT result;
	//シェーダーの読み込みとコンパイル
...
void Bloom::Draw(int TexNum1, int TexNum2, int TexNum3, int TexNum4)
{
	int Num = 0;
