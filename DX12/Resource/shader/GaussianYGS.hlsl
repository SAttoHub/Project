...
)
{
	...
	if (!input[0].Draw3D) {
		...
		for (int i = 0; i < 4; i++) {
			...
			element[i].texel0 = texel + float2(0.0f, -1.0f / g_Height);
			element[i].texel1 = texel + float2(0.0f, -3.0f / g_Height);
			element[i].texel2 = texel + float2(0.0f, -5.0f / g_Height);
			element[i].texel3 = texel + float2(0.0f, -7.0f / g_Height);
			element[i].texel4 = texel + float2(0.0f, -9.0f / g_Height);
			element[i].texel5 = texel + float2(0.0f, -11.0f / g_Height);
			element[i].texel6 = texel + float2(0.0f, -13.0f / g_Height);
			element[i].texel7 = texel + float2(0.0f, -15.0f / g_Height);
