...
float4 main(GaussianGSOutput input) : SV_TARGET
{
	...
	Out += (tex.Sample(smp, input.texel0) + tex.Sample(smp, float2(input.texel7.x, input.texel7.y + g_OffsetY))) * g_Weight0;
	Out += (tex.Sample(smp, input.texel1) + tex.Sample(smp, float2(input.texel6.x, input.texel6.y + g_OffsetY))) * g_Weight1;
	Out += (tex.Sample(smp, input.texel2) + tex.Sample(smp, float2(input.texel5.x, input.texel5.y + g_OffsetY))) * g_Weight2;
	Out += (tex.Sample(smp, input.texel3) + tex.Sample(smp, float2(input.texel4.x, input.texel4.y + g_OffsetY))) * g_Weight3;
	Out += (tex.Sample(smp, input.texel4) + tex.Sample(smp, float2(input.texel3.x, input.texel3.y + g_OffsetY))) * g_Weight4;
	Out += (tex.Sample(smp, input.texel5) + tex.Sample(smp, float2(input.texel2.x, input.texel2.y + g_OffsetY))) * g_Weight5;
	Out += (tex.Sample(smp, input.texel6) + tex.Sample(smp, float2(input.texel1.x, input.texel1.y + g_OffsetY))) * g_Weight6;
	Out += (tex.Sample(smp, input.texel7) + tex.Sample(smp, float2(input.texel0.x, input.texel0.y + g_OffsetY))) * g_Weight7;
