...
)
{
	...
	if (!input[0].Draw3D) {
		...
		for (int i = 0; i < 4; i++) {
			...
			//float2 aa = mul(mat, element[i].svpos);
...
//			element[i].svpos = float4(0, 0, 0, 0);
//			element[i].color = float4(1, 1, 1, 1);
//			element[i].pos = float4(0, 0, 0, 0);
//			
//			element[i].texel0 = float2(0, 0);
//			element[i].texel1 = float2(0, 0);
//			element[i].texel2 = float2(0, 0);
//			element[i].texel3 = float2(0, 0);
//			element[i].texel4 = float2(0, 0);
//			element[i].texel5 = float2(0, 0);
//			element[i].texel6 = float2(0, 0);
//			element[i].texel7 = float2(0, 0);
//		}
//
//		float y1 = input[0].pos1.y;
//		float y2 = input[0].pos2.y;
