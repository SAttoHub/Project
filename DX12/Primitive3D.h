...
#include "CubePrimitive3D.h"
#include "LinePrimitive3D.h"
#include "OctahedronPrimitive.h"
#include "IcosahedronPrimitive.h"
#include "TetrahedronPrimitive.h"
...
private: // 箱プリミティブ専用
	...
	// 箱プリミティブデータ
	static const int MaxCubePrimitives = 128; // 箱プリミティブ最大数
...
private: // 正四面体プリミティブ専用
	...
	// 正四面体プリミティブデータ
	static const int MaxTetrahedronPrimitives = 4; // 正四面体プリミティブ最大数
...
private: // 正八面体プリミティブ専用
	...
	// 正八面体プリミティブデータ
	static const int MaxOctahedronPrimitives = 4; // 正八面体プリミティブ最大数
...
private: //	正二十面体プリミティブ専用
	...
	// 正二十面体プリミティブデータ
	static const int MaxIcosahedronPrimitives = 4; // 正二十面体プリミティブ最大数
